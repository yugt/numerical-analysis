...
\begin{enumerate}
    ...
    \begin{proof}
     ...
     By \hyperref[Heine-Borel]{Heine-Borel theorem}, every closed bounded subset of $\R$ is compact.
...
Applying \hyperref[cauchymean]{Cauchy's Mean Value Theorem} $n+1$ times, \(\exists c_1,c_2,\cdots,c_{n+1}\in[a,x]\) such that
\begin{align*}
